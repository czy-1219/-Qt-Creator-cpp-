...
以下内容基于文件夹中的配置文件CMakeUserPresets.json （qt系统生成文件）显示的环境编写
源代码文件夹已经上传到GitHub，clone链接https://github.com/czy-1219/ddcar2.git  后面有所更改，没有上传，尤其是两个md文件
